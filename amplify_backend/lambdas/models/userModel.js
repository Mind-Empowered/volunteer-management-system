...
var userSchema = new mongoose_1.Schema({
    ...
    role: { type: String, enum: Object.values(user_1.UserRole), default: user_1.UserRole.VOLUNTEER },
    status: { type: String, enum: Object.values(user_1.UserStatus), default: user_1.UserStatus.PENDING },
    phoneNumber: { type: String },
    bloodGroup: { type: String },
    location: { type: String },
    skills: { type: [String], default: [] },
    registeredEvents: { type: [mongoose_1.Schema.Types.ObjectId], ref: 'Event', default: [] },
}, { timestamps: true });
